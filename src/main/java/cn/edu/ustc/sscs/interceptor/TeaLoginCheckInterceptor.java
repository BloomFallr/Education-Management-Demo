...
public class TeaLoginCheckInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull Object handler) {
        ...
        try {
            Integer id = JWTUtil.getIdFromToken(jwtProperties.getTeaSecret(), token);
            String identity = JWTUtil.getIdentityFromToken(jwtProperties.getTeaSecret(), token);
